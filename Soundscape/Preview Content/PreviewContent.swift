...
struct PreviewContent {
    ...
    init() {
        ...
        // Tavern Brawl Music
        element = Element(context: managedObjectContext)
        element.kind = .music
        element.slug = "tavern-brawl-music"
        element.title = "Tavern Brawl Music"
        element.startDelay = 1...1
        element.sampleGap = 5...10
        element.order = .shuffled
        soundset.addToElements(element)
        ...
        element.startDelay = 2.5...2.5
        element.sampleGap = -1...2

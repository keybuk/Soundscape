...
struct PreviewContent {
    ...
    init() {
        ...
        soundset.activeImageData = UIImage(named: "LakeTown")?.jpegData(compressionQuality: 1.0)
        ...
        // Tavern Music
        var playlist = Playlist(context: managedObjectContext)
        playlist.kindRawValue = Playlist.Kind.music.rawValue
        playlist.slug = "tavern-music"
        playlist.title = "Tavern Music"
        playlist.minStartDelay = 3
        playlist.maxStartDelay = 6
        playlist.minSampleGap = 3
        playlist.maxSampleGap = 6
        playlist.orderRawValue = Playlist.Order.shuffled.rawValue
        soundset.addToPlaylists(playlist)

        var playlistParameter = PlaylistParameter(context: managedObjectContext)
        playlistParameter.playlist = playlist
        playlistParameter.isPlaying = true
        playlistParameter.volume = 0.4
        (soundset.moods!.array[0] as! Mood).addToPlaylists(playlistParameter)

        playlistParameter = PlaylistParameter(context: managedObjectContext)
        playlistParameter.playlist = playlist
        playlistParameter.isPlaying = false
        (soundset.moods!.array[1] as! Mood).addToPlaylists(playlistParameter)
        ...
        var playlistEntry = PlaylistEntry(context: managedObjectContext)
        playlistEntry.sample = sample
        playlist.addToEntries(playlistEntry)
        ...
        playlist.kindRawValue = Playlist.Kind.music.rawValue
        playlist.slug = "tavern-brawl-music"
        playlist.title = "Tavern Brawl Music"
        playlist.minStartDelay = 1
        playlist.maxStartDelay = 1
        playlist.minSampleGap = 5
        playlist.maxSampleGap = 10
        playlist.orderRawValue = Playlist.Order.shuffled.rawValue
        soundset.addToPlaylists(playlist)
        ...
        // Barghest Roar
        playlist = Playlist(context: managedObjectContext)
        playlist.kindRawValue = Playlist.Kind.effect.rawValue
        playlist.slug = "barghest-roar"
        playlist.title = "Barghest Roar"
        playlist.minStartDelay = 3
        playlist.maxStartDelay = 3
        playlist.minSampleGap = 3
        playlist.maxSampleGap = 6
        playlist.orderRawValue = Playlist.Order.shuffled.rawValue
        soundset.addToPlaylists(playlist)
        ...
        playlist = Playlist(context: managedObjectContext)
        playlist.kindRawValue = Playlist.Kind.effect.rawValue
        playlist.slug = "weapon-impacts"
        playlist.title = "Weapon Impacts"
        playlist.minStartDelay = 2.5
        playlist.maxStartDelay = 2.5
        playlist.minSampleGap = -1
        playlist.maxSampleGap = 2
        playlist.initialVolume = 0.5
        playlist.orderRawValue = Playlist.Order.shuffled.rawValue
        soundset.addToPlaylists(playlist)
        ...
        // Waterdhavians
        playlist = Playlist(context: managedObjectContext)
        playlist.kindRawValue = Playlist.Kind.oneShot.rawValue
        playlist.slug = "waterdhavians"
        playlist.title = "Waterdhavians"
        playlist.orderRawValue = Playlist.Order.random.rawValue
        playlist.isRepeating = false
        soundset.addToPlaylists(playlist)
